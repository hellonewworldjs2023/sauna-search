...
const WeatherForecast = () => {
  ...
  return (
    <>
        <p>あ</p>
        <div id="location"><p>A</p><a href="https://www.jma.go.jp/bosai/forecast/" target="_blank">気象庁のデータを元に作成</a></div>
        <div className="weatherForecast w-[840px] h-[120px] text-center border border-solid border-black flex">
            {timeDefinesList.map((time) =>
             
              <div className="weather w-1/7 box-border border border-solid border-[#666]" key={time}>
                <div className="date text-sm"><p>a</p></div>
                <div className="weatherImg text-sm"><p>c</p></div>
                <div className="weatherTelop text-sm"><p>d</p></div>
                <div className='text-sm'><span className="tempMin text-blue-600">{tempsMinList[time]}℃</span>/<span class="tempMax text-red-600">{tempsMaxList[time]}℃</span></div>
              </div>
            )}
        </div>
{/* <script>
